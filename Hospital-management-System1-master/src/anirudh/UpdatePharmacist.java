...
public class UpdatePharmacist extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        label1.setText("Update Pharmacist");
        ...
        jButton2.setBounds(790, 150, 120, 50);
        jPanel1.add(t0);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String name,age,gender,qualifaction,mo,address,password;
            ...
            Connection con = DriverManager.getConnection( 
               ...
               String q1="update  pharmacist set name='"+name1+"',age='"+age1+"',gender='"+gender1+"',qualification='"+ qualifiaction1+"',mo='"+mo1+"',address='"+address1+"',password='"+password1+"' where id='"+id1+"'";
